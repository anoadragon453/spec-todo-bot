...
The majority of the code is kept inside of the `spec_todo_bot` folder, which
...
To run the bot, the `spec-todo-bot` script in the root of the codebase is
